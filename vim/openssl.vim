...
"
" If you edit any file named '.pwsafe.bfa' (that's the full name, not just the
...
" quit Vim. Create the following example file named ~/.pwsafe.bfa:
"
"     == Colo server ==
"
...
" '.pwsafe.bfa'. The file is encrypted with Blowfish and base64 encoded.
...
autocmd BufReadPost,FileReadPost   .pwsafe.bfa set foldexpr=HeadlineDelimiterExpression(v:lnum)
autocmd BufReadPost,FileReadPost   .pwsafe.bfa set foldlevel=0
autocmd BufReadPost,FileReadPost   .pwsafe.bfa set foldcolumn=0
autocmd BufReadPost,FileReadPost   .pwsafe.bfa set foldmethod=expr
autocmd BufReadPost,FileReadPost   .pwsafe.bfa set foldclose=all
autocmd BufReadPost,FileReadPost   .pwsafe.bfa set foldtext=getline(v:foldstart)
autocmd BufReadPost,FileReadPost   .pwsafe.bfa nnoremap <silent><space> :exe 'silent! normal! za'.(foldlevel('.')?'':'l')<CR>
autocmd BufReadPost,FileReadPost   .pwsafe.bfa nnoremap <silent>q :q<CR>
autocmd BufReadPost,FileReadPost   .pwsafe.bfa highlight Folded ctermbg=blue ctermfg=yellow
autocmd BufReadPost,FileReadPost   .pwsafe.bfa set updatetime=300000
"autocmd CursorHold                 .pwsafe.bfa quit
" press f1 to insert a new entry
 autocmd BufEnter                   .pwsafe.bfa map <c-n> Go== new ==<cr>username: user<cr>password: pass
" press f2 to insert a generated password
autocmd BufEnter                   .pwsafe.bfa imap <c-n> <ESC>:silent call GeneratePassword()<cr>wa
